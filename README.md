...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-rl8jm0.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-rl8jm0.containers.anotherwebservice.com/
...
```
git clone git@github.com:kevgllt/container-rl8jm0.git
cd container-rl8jm0
```
...
```
docker attach container-rl8jm0
```
